<div class="close_button"> <a href="index.php?r=kfcmongoliahs/tab/index&signed_request=<?php echo CHtml::encode($_REQUEST['signed_request']);?>"> <img src="<?php echo $this->themeUrl;?>/images/close_btn.png" width="41" height="41" /> </a> </div>
  <div class="popup_congratulation">
  	<div class="congratulation_text">
