...
(function($) {
	$.prompt = function(message, options) {
		...
		msgbox += '<div class="'+ $.prompt.options.prefix +'"><div class="'+ $.prompt.options.prefix +'container"><div  onclick="closebox()" class="';
		...
		$.each(message,function(statename,stateobj){
				...
				$.each(stateobj.buttons, function(k, v){
					if(typeof v == 'object'){
						...
						states += '<button onclick="closebox()" name="' + $.prompt.options.prefix + '_' + statename + '_button' + k + '" id="' + $.prompt.options.prefix +  '_' + statename + '_button' + k + '" value="' + v + '">' + k + '</button>';
